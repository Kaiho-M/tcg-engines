...
import { op16WeLlChangeThisMissionFromSneakyToFlashy059I18n } from "./059-we-ll-change-this-mission-from-sneaky-to-flashy.i18n.ts";

export const op16WeLlChangeThisMissionFromSneakyToFlashy059: EventCard = {
  id: "OP16-059",
  canonicalId: "OP16-059",
  slug: "we-ll-change-this-mission-from-sneaky-to-flashy",
  ...
  printings: [
    {
      ...
      collectorNumber: "059",
      rarity: "UC",
      imageUrl: "https://en.onepiece-cardgame.com/images/cardlist/card/OP16-059.png",
    },
  ],
  cardType: "event",
  color: ["blue"],
