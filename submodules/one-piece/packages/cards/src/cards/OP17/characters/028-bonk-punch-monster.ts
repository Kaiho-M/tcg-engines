...
import { op17BonkPunchMonster028I18n } from "./028-bonk-punch-monster.i18n.ts";

export const op17BonkPunchMonster028: CharacterCard = {
  id: "OP17-028",
  canonicalId: "OP17-028",
  slug: "bonk-punch-monster",
  ...
  printings: [
    {
      ...
      collectorNumber: "028",
      rarity: "C",
      imageUrl: "https://en.onepiece-cardgame.com/images/cardlist/card/OP17-028.png",
    },
  ],
  cardType: "character",
  color: ["green"],
