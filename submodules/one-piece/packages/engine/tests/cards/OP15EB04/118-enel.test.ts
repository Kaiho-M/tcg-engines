...
import { op15eb04Enel118 } from "../../../../cards/src/cards/OP15EB04/characters/118-enel.ts";
...
describe("OP15-118 Enel", () => {
  test("gains +2000 power and cannot be removed by opponent effects with 6 or less DON!! on the field", () => {
    const engine = OnePieceTestEngine.create(
      ...
      { character: [op15eb04Enel118, eb01Doma005], activeDon: 6 },
      { firstPlayer: "north", activeSeat: "south" },
    );
    const enelId = engine.findCardInZone("north", "character", op15eb04Enel118);
  ...
  test("has no bonus with 7 or more DON!! on the field", () => {
    const engine = OnePieceTestEngine.create(
      { character: [op15eb04Enel118], activeDon: 7 },
      {},
      { firstPlayer: "north", activeSeat: "south" },
    );
    const enelId = engine.findCardInZone("south", "character", op15eb04Enel118);
  ...
  test("[On Play] DON!! -1 looks at 5, adds 1 to hand, bottoms the rest, then trashes 1 from hand", () => {
    const engine = OnePieceTestEngine.create(
      {
        hand: [op15eb04Enel118, eb01Doma005],
        deck: [
          eb01Fourtricks025,
          eb01Doma005,
          eb01MountainGod018,
        ...
        activeDon: op15eb04Enel118.cost + 1,
      },
      {},
      { firstPlayer: "north", activeSeat: "south" },
    );
    ...
    engine.playCard(op15eb04Enel118, "south");
