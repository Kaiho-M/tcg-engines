...
import { op15eb04LightningDragon077 } from "../../../../cards/src/cards/OP15EB04/events/077-lightning-dragon.ts";
...
describe("OP15-077 Lightning Dragon", () => {
  test("[Main] DON!! -1 draws, then keeps one rested opposing Character with 6000 power or less from refreshing", () => {
    const engine = OnePieceTestEngine.create(
      {
        hand: [op15eb04LightningDragon077],
    ...
    engine.playCard(op15eb04LightningDragon077, "south");
